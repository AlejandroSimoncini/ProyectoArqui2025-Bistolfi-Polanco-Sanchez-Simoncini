...
func InitDB() {
	...
	dsn := "root:@tcp(localhost:3306)/proyectoarquisoft?charset=utf8mb4&parseTime=True&loc=Local" //usuario root, host:localhost:3306,contraseña vacia solo para desarrollo local, bd: proyectoarquisoft.
	var err error
