...
func InitDB() {
	...
	dsn := "root:root@tcp(127.0.0.1:3307)/proyectoarquisoft?charset=utf8mb4&parseTime=True&loc=Local"

	//usuario root, host:mysql:3306,contraseña root, bd: proyectoarquisoft.
	var err error
